...
{
    public class Estudios1Controller : Controller
    {
        private readonly PersonaDbContext _context;

        public Estudios1Controller(PersonaDbContext context)
        {
            _context = context;
        }
